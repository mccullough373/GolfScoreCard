...
The only major change that I have had to make thus far is that I was planning
to use the Natural Number component as sort of a counter for the score. This
started off going well, but when trying to use some of the methods, there were
major aliasing problems, and I found it much easier to just use an integer.
