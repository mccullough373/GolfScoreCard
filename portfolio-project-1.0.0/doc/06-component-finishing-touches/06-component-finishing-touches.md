...
I think that I understand software development a lot better now thanks to this
project. There were many concpets that I had a hard time understanding just
through lectures and labs that I was able to put together through the hands on
approach of this project. For example, convention and correspondence. I had no
idea what either of those were, even thoguh tehy were discussed in class.

> Also, did the portfolio project surface any gaps in your own knowledge of
> software development. If so, what are those gaps and how did you address them?


Yes, there were many gaps that surfaced. One major one was the different types
of classes and how they implement or extend eachother, such as kernel and
secondary. I was able to address these problems by looking extensively through
the osu java api compnents and how they are laid out. I probabaly spent more
time looking through all of the components different classes than actually
implementing mine.
...
This project has really changed my perspective on software development. It was
something that was a requirement for me to do to graduate, to something that
hopefully I can implement into my future career. The way Ohio State teaches
this is very uncondusive to what it really is and just tries to make it as
...
One of the major skills that I picked up was really reading and understanding.
I spent a lot of time looking through java api's and had to really understand
them to be able to implement mine correctly. I also learned perseverance, as
there was many times where I wanted to just stop and quit, or thought that I
wasn't capable of finishing it.
...
This project, more of really this class as a whole has made me not like the
trajectory that I'm on. Coding is something I would like to stay far away from
when choosing a career as I find it not very enjoyable and tedious.
...
Some things that I could do stay on my trajectory, is to really get into
computers and really understand them inside and out. I have an old computer
from about 8 years ago, that I plan to completely dissasemble and reassemble.
Just like a tree! I jest, but keeping my passion for computers will help me
tremendously for my last two years. Some mentors that I know will keep me on
my path are my parents as they have way to high expectations for me and I would
hate to disappoint and my best friend is in engineering as well and we both
agreed that we will finish together.
