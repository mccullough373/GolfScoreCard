...
- [Yes ] I have added my name to the top of this document
- [Yes ] I have added my dot number to the top of this document
- [Yes ] I have added the due date to the top of this document
- [Yes ] I have read the assignment overview in the "Assignment Overview" section
- [Yes ] I have read the assignment learning objectives in the "Assignment Learning Objectives" section
- [Yes ] I have read the assignment rubric in the "Assignment Rubric" section
- [Yes ] I have read this checklist

### Ongoing Tasks

- [Yes ] I have expressed my choice of design and why in the "Pre-Assignment" section
- [Yes ] I have created a proof-of-concept of my design
  - [Yes ] I have created a new Java file in `src`
  - [ Yes] I have defined my representation using a field or fields
  - [ Yes] I have implemented a few methods from my design
  - [ es] I have shown that the methods work through a main method

### Submission Tasks

- [ Yes] I have shared assignment feedback in the "Assignment Feedback" section
- [ Yes] I have converted this document to a PDF
- [Yes ] I have converted my Java code to a PDF
- [Yes ] I am prepared to submit both PDFs on Carmen
- [Yes ] I am prepared to give my peers feedback on their ideas
...
For my design I will be going with the gold data stucture. I feel as if it is
the component I want to do the most as well as it being the easiest to design
and create meaningful methods.
